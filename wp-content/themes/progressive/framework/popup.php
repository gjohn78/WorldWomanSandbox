...
if (isset($_GET['pb_item_id']) && intval($_GET['pb_item_id']) && isset($_GET['builder']) && !empty($_GET['builder']))
{
	...
	$data_field = esc_js($_GET['builder'].'_'.$_GET['pb_item_id']);
}
...
<input id="insert-shortcode" name="save" type="submit" class="button button-primary button-large" id="publish" accesskey="p" value="<?php echo esc_attr($button); ?>">
</form>
</body>
</html>