...
<div class="banner-set banner-set-mini banner-set-no-pagination load banner-border-shop">
	<div class="container">
		<div class="banners">
			<?php
			$width = 127;
			...
			if (have_posts()) : while (have_posts()) : the_post();
					...
					?>
					<a href="<?php esc_url(get_permalink()); ?>" class="banner">
...
<div class="page" id="main">
        ...
        <div class="container">
			<h1 class="title">
				...
				if (is_shop()) {
					...
					_e('Product Category', 'progressive');
				} else {
					the_title();
				}
				?>
    ...
    <div class="container">
		<div class="row">     
			...
			<?php if (isset($_GET['layout']) && $_GET['layout'] == 'list' && is_shop()) echo '<div class="content col-sm-12 col-md-9" id="catalog">'; ?>
			<?php
...
<?php if (is_shop()) { ?>
				...
				<?php if (!empty($xv_data['shop_header_img']['thumbnail'])) { ?>
					...
					if (isset($xv_data['shop_page_top_title'])) {
						...
						echo '<div class="description">' . esc_html($shop_title) . '</div>';
					}
					?>
				</div>
